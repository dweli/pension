...
import com.kedi.bilanshan.config.ServiceFeignConfiguration;
...
@FeignClient(value ="product-center",configuration = ServiceFeignConfiguration.class)
public interface BilanshanService {
